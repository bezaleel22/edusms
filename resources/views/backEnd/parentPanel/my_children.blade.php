            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <ul class="nav nav-tabs tabs_scroll_nav" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#studentRecord" role="tab" data-toggle="tab">@lang('student.student_record')</a>
                        </li>
                    ...
                    <!-- Start Profile Tab -->
                        ...
                        <!-- delete document modal -->
                        <!-- Start StudentRecoed Tab -->
                        <div role="tabpanel" class="tab-pane fade" id="studentRecord">
                            <div class="white-box">
                                        ...
                                        <div class="single-activity">
                                            ...
                                            <div class="sub-activity-box d-flex">
                                                ...
                                                <div class="close-activity">
                                                    ...
                                                    @elseif ($timeline->file)
                                                        <a href="{{$timeline->file}}"
                                                           class="primary-btn tr-bg text-uppercase bord-rad" download>
                                                            @lang('common.download')<span class="pl ti-download"></span>
                                                        </a>
                                                    @endif
