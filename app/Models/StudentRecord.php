...
class StudentRecord extends Model
{
    ...
    {
        return $this->hasMany('App\SmStudentTimeline', 'staff_student_id', 'student_id');
    }
    public function student()
    {
        return $this->hasOne('App\SmStudent', 'id', 'student_id')
            ->select('id', 'full_name', 'user_id', 'student_photo', 'admission_no', 'custom_field', 'parent_id', 'student_category_id')
            ->with(array('parents' => function ($query) {
                $query->select('id', 'fathers_name', 'mothers_name', 'guardians_email', 'guardians_name');
            }))
            ->with('category')
            ->withDefault();
    }
    ...
    {
        return $this->hasMany('App\SmResultStore', 'student_id', 'student_id');
    }
