...
class SmStaff extends Model
{
    ...
    {
        return $this->belongsTo('App\SmClassTeacher', 'teacher_id', 'id');
    }

    public function departments()
    {
        return $this->belongsTo('App\SmHumanDepartment', 'designation_id', 'id');
    }
    ...
    public function subjects()
    {
        return $this->hasMany('App\SmAssignSubject', 'teacher_id', 'id')
            ...
            ->select('sm_assign_subjects.*', 'sm_classes.id', 'sm_classes.class_name', 'sm_sections.section_name', 'sm_subjects.subject_name', 'sm_subjects.subject_code', 'sm_subjects.subject_type');
    }
